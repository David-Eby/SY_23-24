...
Partial Class ReelControl
    ...
    Private Sub InitializeComponent()
        ...
        Me.ImageList1.Images.SetKeyName(0, "seven.png")
        Me.ImageList1.Images.SetKeyName(1, "Clover.png")
        Me.ImageList1.Images.SetKeyName(2, "Star.png")
        Me.ImageList1.Images.SetKeyName(3, "Bell.png")
        Me.ImageList1.Images.SetKeyName(4, "Cherry.png")
        Me.ImageList1.Images.SetKeyName(5, "Watermelon.png")
        Me.ImageList1.Images.SetKeyName(6, "Lemon.png")
        Me.ImageList1.Images.SetKeyName(7, "Banana.png")
        '
        'Timer1
        '
